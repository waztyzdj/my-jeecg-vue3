...
<script lang="ts" setup>
  ...
  import { utils } from '/@/utils/flow/common';
  import FlowNode from './FlowNode.vue';
  import { useContextMenu } from '/@/hooks/flow/useContextMenu';
  import { CommonNodeTypeEnum, LaneNodeTypeEnum, ToolsTypeEnum, NodeTypeEnum } from '/@/type/flow/enums';
  import { INode, ILink, ITool, IDragInfo, IElement } from '/@/type/flow/index';
  import { commonNodes, highNodes, laneNodes } from '/@/config/flow/nodes';
  import { useAlign } from '/@/hooks/flow/useAlign';
