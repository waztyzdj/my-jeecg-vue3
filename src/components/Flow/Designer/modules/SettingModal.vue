...
<script lang="ts" setup>
  ...
  import { ISettingConfig } from '/@/type/flow/index';
  import { settingConfig as defaultSettingConfig } from '/@/config/flow/flow';
  import { setFlowConfig } from '/@/utils/flow/common';
