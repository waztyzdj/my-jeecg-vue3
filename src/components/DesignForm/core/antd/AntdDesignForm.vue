<template>
  <div class="fc-style">
    <a-layout class="fc-container">
      <a-layout-content class="fc-main">
        <a-layout>
          ...
          >
            <a-layout>
              <a-layout-header>
                <a-tabs v-model:activeKey="configTab" :tab-bar-style="{ marginBottom: '24px', paddingLeft: '16px' }">
                  <a-tab-pane key="widget" tab="字段属性" @click="configTab = 'widget'">
                  </a-tab-pane>
                  <a-tab-pane key="form" tab="表单属性" force-render @click="configTab = 'form'">
                  </a-tab-pane>
                </a-tabs>
              </a-layout-header>
      ...
      <a-modal v-model:visible="previewVisible" :width="1200" style="padding: 24px;">
        <AntdGenerateForm
          style="margin-top: 20px;padding: 24px;padding-top: 64px;"
          ref="generateFormRef"
          :data="widgetForm"
        />
        <template #footer>
...
import CodeEditor from '/@/components/DesignForm/components/CodeEditor.vue'
import ComponentGroup from '/@/components/DesignForm/components/ComponentGroup.vue'
...
import { antd } from '/@/components/DesignForm/config'
import { copy } from '/@/components/DesignForm/utils'
import { CodeType, PlatformType } from '/@/components/DesignForm/enums'
import generateCode from '/@/components/DesignForm/utils/generateCode'
import { WidgetForm } from '/@/components/DesignForm/config/antd'
