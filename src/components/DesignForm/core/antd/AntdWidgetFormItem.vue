<template>
  <div class="widget-item-container">
    ...
    <div class="widget-view-action" v-if="selectWidget?.key === element.key">
      <SvgIcon icon="ant-design:copy-outlined" @click.stop="$emit('copy')" />
      <SvgIcon icon="ant-design:delete-outlined" @click.stop="$emit('delete')" />
    </div>

    <div class="widget-view-drag" v-if="selectWidget?.key === element.key">
      <SvgIcon icon="ant-design:drag-outlined" className="drag-widget" />
    </div>
  </div>
</template>
...
import SvgIcon from '/@/components/DesignForm/components/SvgIcon.vue'
import RichTextEditor from '/@/components/DesignForm/components/RichTextEditor.vue'
