<template>
  <div>
    ...
    <!-- 表单区域 -->
    <OaDefineFlowModal @register="registerModal" @success="handleSuccess"></OaDefineFlowModal>
    <!-- 设计区域 -->
    <OaDefineFlowDesignModal @register="designModal" :minHeight="100" @success="handleSuccess"/>
    <!-- 历史版本列表 -->
    <OaDefineFlowVersionListModal @register="versionListModal" width="60%"/>
  </div>
</template>

<script lang="ts" name="define-oaDefineFlow" setup>
import { ref, computed, unref } from 'vue';
import { BasicTable, useTable, TableAction } from '/@/components/Table';
import { useModal } from '/@/components/Modal';
import { useListPage } from '/@/hooks/system/useListPage';
import OaDefineFlowModal from './components/OaDefineFlowModal.vue';
import OaDefineFlowDesignModal from './components/OaDefineFlowDesignModal.vue';
import OaDefineFlowVersionListModal from './components/OaDefineFlowVersionListModal.vue';
import { columns, searchFormSchema } from './OaDefineFlow.data';
import { list, deleteOne, audit, addConfig, batchDelete, getImportUrl, getExportUrl } from './OaDefineFlow.api';
